...
- [ ] Required checks pass (`./gradlew test` if tests are present)
- [ ] Manual validation completed for changed flows
- [ ] Commit message follows format
- [ ] Changes are atomic

If AI environment lacks build tools/SDK, AI should output the exact check commands for human execution and wait for human-reported results.
